...
<body>
    ...
    <nav class="navbar py-2 navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">GRIP's BANK <img src="logos/logo.webp" alt="Bank" width="50" height="50"></a>
    ...
    <div id="carouselExampleCaptions" class="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="background/1.jpg" width="1000" height="600" class="d-block w-100" alt="...">

            </div>
            <div class="carousel-item">
                <img src="background/4.jpg" width="1000" height="600" class="d-block w-100" alt="...">

            </div>
             <div class="carousel-item">
                <img src="background/3.jpg" width="1000" height="600" class="d-block w-100" alt="...">
